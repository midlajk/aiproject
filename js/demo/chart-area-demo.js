...
*/
    ...
    polygonTemplate.stroke = am4core.color("#40E0D0");
    ...
    imageSeries.mapImages.template.events.on("hit", function(ev) {
        window.open(ev.target.dataItem.dataContext.site, '_blank');
...
<tr>
<th align="left">Something1</th>
<td>{something}</td>
</tr>
<tr>
<th align="left">Something2</th>
<td>{somwthing2}</td>
</tr>
